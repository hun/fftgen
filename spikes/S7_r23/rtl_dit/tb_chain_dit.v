...
module tb;
    ...
    wire muser, mlast;
    fft_sdf_r23_dit #(
        .NUM_POINTS(65536), .SAMPLE_WIDTH(16), .INTERN_WIDTH(16),
        .TWIDDLE_WIDTH(18), .TWIDDLE_DECIMAL(17),
        .SCALING_PACK(64'h55555555),
        .INVERSE(1), .TWIDDLE_FILE("/home/hannes/Projects/fftgen/spikes/S7_r23/rtl_dit/tw_chain_65536.mem"), .Q8(92682),
    ...
    always #5 clk = ~clk;
    initial begin
        $readmemh("/home/hannes/Projects/fftgen/spikes/S7_r23/rtl_dit/stim_chain_65536.txt", stim);
        fd = $fopen("/home/hannes/Projects/fftgen/spikes/S7_r23/rtl_dit/rtl_chain_65536.txt", "w");
