...
module tb;
    ...
    fft_sdf_r23_dit #(
        ...
        .SCALING_PACK(64'h15555),
        .INVERSE(1), .TWIDDLE_FILE("/home/hannes/Projects/fftgen/spikes/S7_r23/rtl_dit/tw_chain_512.mem"), .Q8(92682),
        .KP_T0(7), .KP_T1(-1), .KP_T2(-1),
    ...
    always #5 clk = ~clk;
    initial begin
        $readmemh("/home/hannes/Projects/fftgen/spikes/S7_r23/rtl_dit/stim_chain_512.txt", stim);
        fd = $fopen("/home/hannes/Projects/fftgen/spikes/S7_r23/rtl_dit/rtl_chain_512.txt", "w");
