...
module tb;
    ...
    initial begin
        ...
        for (c = 0; c < T; c = c + 1) begin
            ...
            @(posedge clk);
            #1;
            if (dut.phase7 && dut.g_p < 3)
                $display("combine k=%0d g=%0d: w3=%0d %0d w4=%0d %0d gq3=%0d gq4=%0d",
                         dut.k, dut.g_p, dut.w3_q, dut.w3_i[8:0], dut.w4_q,
                         dut.w4_i[8:0], dut.gq3, dut.gq4);
            @(negedge clk);
        end
        $finish;
    end
