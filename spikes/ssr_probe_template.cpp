...
int main(int argc, char** argv) {
    ...
    for (long j = 0; j < @F@; j++) {
        ...
        printf("CYC j=%ld iv=%d "
            ...
            (int)(short)rr.fft_ssr__DOT__lanes__BRA__0__KET____DOT__u_lane__DOT__m_axis_tdata_re,
            (int)(short)rr.fft_ssr__DOT__lanes__BRA__0__KET____DOT__u_lane__DOT__m_axis_tdata_im,
            (int)rr.fft_ssr__DOT__lanes__BRA__0__KET____DOT__u_lane__DOT__m_axis_tuser,
            (int)rr.fft_ssr__DOT__lanes__BRA__0__KET____DOT__u_lane__DOT__m_axis_tvalid,
            (int)(short)rr.fft_ssr__DOT__lanes__BRA__1__KET____DOT__u_lane__DOT__m_axis_tdata_re,
            (int)(short)rr.fft_ssr__DOT__lanes__BRA__1__KET____DOT__u_lane__DOT__m_axis_tdata_im,
            (int)rr.fft_ssr__DOT__lanes__BRA__1__KET____DOT__u_lane__DOT__m_axis_tuser,
            (int)rr.fft_ssr__DOT__lanes__BRA__1__KET____DOT__u_lane__DOT__m_axis_tvalid,
