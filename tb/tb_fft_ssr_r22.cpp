// fft_ssr Verilator testbench: R-wide word interface over the flat
// stimulus stream. Reads stimulus.txt (re im user last per line, hex,
// natural order), groups into R-sample words, drives fft_ssr, captures
// valid output words flattened into actual.txt (one line per sample).
#include <cstdio>
#include <cstdlib>
#include <cstdint>
#include <fstream>
...
int main(int argc, char** argv) {
    ...
    Vfft_ssr_r22* dut = new Vfft_ssr_r22;
